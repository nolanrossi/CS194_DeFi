...
# Calculate short and long SMAs (10-day and 50-day) for momentum
short_sma = data.rolling(window=10).mean()
long_sma = data.rolling(window=50).mean()

# Step 3: Define a function for threshold-based volatility management and refined momentum filtering
...
# Step 5: Apply weights to weekly returns and calculate portfolio returns
...
# Calculate portfolio value over time, explicitly casting to float to avoid warnings
